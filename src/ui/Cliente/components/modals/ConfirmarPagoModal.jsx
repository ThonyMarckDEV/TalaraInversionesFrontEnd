...
import { CreditCard, Upload, Landmark } from 'lucide-react'; // Importamos nuevos íconos

const ConfirmarPagoModal = ({ cuota, onConfirm, onClose, loading, isCancelacion = false }) => {
    
    // --- ESTADOS LOCALES ---
    const [paymentMethod, setPaymentMethod] = useState('yape'); // 'yape' o 'banco'
    ...
    const handleFileChange = (e) => {
        ...
        if (file) {
            ...
            setError(''); // Limpiamos el error si el usuario selecciona un archivo
        }
    };

    const handleSubmit = (e) => {
        e.preventDefault();
        // Validamos que se haya adjuntado un comprobante
        if (!comprobanteFile) {
        ...
        formData.append('monto_pagado', parseFloat(montoFinalAPagar));
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Tabs para seleccionar Yape o Banco */}
                            ...
                            {/* Contenido condicional del método de pago */}
